...
class BlackWolfClient:
    ...
    def download_daily(self, stock_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        ...
        params = {"code": stock_code, "start": start_date, "end": end_date}
    ...
    def download_5m(self, stock_code: str, start_date: str, end_date: str) -> pd.DataFrame:
...
def save_kline_data(df: pd.DataFrame, output_path: Path, stock_code: str, timeframe: str):
