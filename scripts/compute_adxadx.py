#!/usr/bin/env python3
"""Compute the StrategyQuant SqADXADX indicator from CSV or Foundation DB bars."""
...
from scripts.indicators.adxadx import ADXADXConfig, compute_adxadx  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compute SqADXADX buffers.")
    ...
    parser.add_argument("--adxadx-period", type=int, default=30)
    parser.add_argument("--slope-bars", type=int, default=3)
    parser.add_argument("--level-active", type=float, default=20.0)
    parser.add_argument("--level-closed", type=float, default=13.0)
    parser.add_argument("--level-dormant", type=float, default=9.0)
...
def main() -> None:
    ...
    config = ADXADXConfig(
        ...
        adxadx_period=args.adxadx_period,
        slope_bars=args.slope_bars,
        level_active=args.level_active,
        level_closed=args.level_closed,
        level_dormant=args.level_dormant,
    )
