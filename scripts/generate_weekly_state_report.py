...
def main() -> None:
    ...
    recent_full_div = sum(w["full_divergence_rate"] * w["total"] for w in recent) / recent_total if recent_total else 0
    recent_pos_div = sum(w["position_divergence_rate"] * w["total"] for w in recent) / recent_total if recent_total else 0
    ...
    mature_full_div = sum(w["full_divergence_rate"] * w["total"] for w in mature) / mature_total if mature_total else 0
    mature_pos_div = sum(w["position_divergence_rate"] * w["total"] for w in mature) / mature_total if mature_total else 0
